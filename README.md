...
- **[animated-documentary-brief](skills/animated-documentary-brief)** - Produce a complete solo-build production brief for a Fern-style animated documentary: shot list with AI tool assignments and generation prompts, voiceover settings, edit rhythm, music map, thumbnail concepts, and publish checklist
